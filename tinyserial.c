 ...
 *
 * Updated 2022 to add more baud rates
 *
 */
...
int main(int argc, char *argv[])
{
	...
	newkey.c_cflag = __MAX_BAUD | CRTSCTS | CS8 | CLOCAL | CREAD;
	...
	// if no port speed was specified, don't adjust speed setting
	if (argc == 2 ) {
